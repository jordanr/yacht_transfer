...
module YachtTransfer
  module Rails
    module Helper
      ...
      def length_units_select;  select(:specification, :length_units_id, options_with_ids(length_unitses)); end
      def weight_units_select;  select(:specification, :weight_units_id, options_with_ids(weight_unitses)); end
      def volume_units_select;  select(:specification, :volume_units_id, options_with_ids(volume_unitses)); end
      def speed_units_select;  select(:specification, :speed_units_id, options_with_ids(speed_unitses)); end
